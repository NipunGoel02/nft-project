...
const HackathonCertificate = () => {
  ...
  useEffect(() => {
    const fetchHackathon = async () => {
      try {
        const response = await axios.get(`http://localhost:5000/api/hackathons/${hackathonId}`);
  ...
  const handleMintNFT = async () => {
    ...
    try {
      ...
      const metadata = {
        name: `${hackathon.title} Certificate`,
        description: `Certificate for participating in ${hackathon.title}`,
        image: imageURI,
        attributes: [
          { trait_type: "Hackathon", value: hackathon.title },
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-xl shadow-md p-6 mb-8">
            <h1 className="text-2xl font-bold text-gray-800 mb-4">Congratulations on Participating in the Hackathon!</h1>
            <p className="text-gray-600 mb-6">
              You've successfully participated in "{hackathon.title}" and earned this certificate.
            ...
            <div className="mb-8 p-4 bg-gray-50 rounded-lg">
              ...
              >
                ...
                <div className="text-center mb-6">
                  <h2 className="text-3xl font-bold text-teal-800 mb-1">Certificate of Participation</h2>
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-gray-600">has successfully participated in the hackathon</p>
                  <h4 className="text-xl font-bold text-teal-700 mt-2">"{hackathon.title}"</h4>
                </div>
                <div className="flex justify-between items-end mt-12">
                  <div className="text-center">
                    <div className="w-40 h-px bg-gray-400 mb-1"></div>
                    <p className="text-gray-600">{hackathon.organizer?.name || "Organizer"}</p>
                ...
                <div className="absolute bottom-4 right-4 text-xs text-gray-400">
                  Certificate ID: HACK-{hackathonId}-{Date.now().toString().slice(-6)}
                </div>
              </div>
            </div>
